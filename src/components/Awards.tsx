...
const awards = [
  ...
  },
  {
    year: '2021',
    color: 'orange',
    title: 'Top 10 ONGs de SP',
    org: 'Associação Paulistana de ONGs',
    desc: 'Selecionados entre as 10 organizações com maior impacto social em São Paulo.',
    icon: '🥇',
  },
  {
    year: '2020',
    ...
    org: 'Câmara Municipal de São Paulo',
